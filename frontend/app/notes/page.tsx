          ...
          <div className="bg-white dark:bg-[#111113] border border-slate-200 dark:border-slate-800 rounded-2xl max-w-md w-full shadow-2xl overflow-hidden p-6 relative">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1.5 leading-relaxed">
                  {pendingCourse ? (
                    <>Link this note to <span className="font-bold text-slate-800 dark:text-slate-200">&ldquo;{pendingCourse}&rdquo;</span>? The AI assistant will use this note when generating study material for that course.</>
                  ) : (
